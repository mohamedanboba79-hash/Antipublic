...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'clean':
        await query.edit_message_text(
            ...
            "يمكنك إرسال ملف بصيغة TXT أو CSV، أو لصق النص مباشرة.\n\n"
        ...
        await query.edit_message_text(
            ...
            "3️⃣ اضغط 'Apply Filters'\n"
            "4️⃣ اضغط 'Send to Bot'\n\n"
    ...
    # ===== عمليات BIN =====
        ...
        await query.edit_message_text("📤 **أرسل ملف البطاقات**")
        context.user_data['bin_action'] = 'extract_bins'
        
    elif query.data == 'remove_bins':
        await query.edit_message_text("🗑️ **أرسل ملف البطاقات**")
        context.user_data['bin_action'] = 'remove_bins'
        
    elif query.data == 'sort_cards':
        await query.edit_message_text("📊 **أرسل ملف البطاقات للترتيب**")
        ...
        await query.edit_message_text("🔍 **أرسل ملف البطاقات للتحقق**")
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == 'clean':
        ...
        if cleaned:
            ...
            await update.message.reply_text("❌ **لا توجد بطاقات صالحة!**", parse_mode='Markdown')
...
async def webapp_data_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ تم استلام طلبك من الويب اب!")
